...
export const projects = [
    {
        ...
        github: [
            {name: "server",
            url : "https://github.com/kwurty/jillcrate-server"},
            {name: "client",
            url: 'https://github.com/kwurty/jillcrate-client'}
        ],
    ...
    },
    {
        ...
        github: [{
         name: "client",
         url: "https://github.com/kwurty/artist-organizer"
        }],
    ...
    },
    {
        ...
        github: [
            {name: "server", url: "https://github.com/kwurty/fastapi-training"},
                    {name: "client", url: "https://github.com/kwurty/simple-posts-frontend"}],
    ...
    },
    {
        ...
        github: [{name: "client", url: "https://github.com/kwurty/pokedex"}],
